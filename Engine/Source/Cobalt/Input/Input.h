...
namespace Cobalt
{
	...
	public:
		...
		static bool GetMouseButtonDoubleClicked(int button) { return s_Input->GetMouseButtonDoubleClickedImpl(button); }
	...
	private:
		...
		bool GetMouseButtonDoubleClickedImpl(int button);
