...
public:
	...
	static void DrawRect(ImVec2 cursor_pos, ImVec2 content_region, float height, const Color& color, float radius = 0.0f);
	static void DrawRectOutlined(ImVec2 cursor_pos, ImVec2 content_region, float height, const Color& color, float outlineWidth, const Color& outlineColor, float radius = 0.0f);
